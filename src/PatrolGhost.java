...
public class PatrolGhost extends Ghost {
    private int row = 11;
    private int col = 1;
    ...
    private static final String IMG_FILE_NORMAL = "files/patrol.png";
    private static BufferedImage imgNormal;
    private static BufferedImage imgFright;
   
    public PatrolGhost(int courtWidth, int courtHeight) {
  ...
  public void move() {
        ...
        if (!isNextCellNavigable(direction)) {
